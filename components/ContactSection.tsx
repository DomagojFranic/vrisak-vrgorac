...
export default function ContactSection() {
  return (
    <section className="py-8 px-8 bg-white rounded-md w-full">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-black ml-1 mb-8">Kontakt</h2>
        <div className="flex flex-col md:flex-row gap-8">
          {/* Map */}
          <div className="w-full md:w-2/3 h-[250px] rounded-lg overflow-hidden shadow-md transition-all duration-300 transform hover:scale-105">
            <iframe
